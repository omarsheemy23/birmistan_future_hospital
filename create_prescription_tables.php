...
echo "<h1>Creating Prescription Tables</h1>";
...
try {
    ...
    if ($checkStmt->rowCount() > 0) {
        ...
        // Try to identify if the prescriptions table exists
        ...
        // Try to identify if the medicines table exists
        ...
        if ($checkMedicinesStmt->rowCount() == 0) {
            ...
            echo "<p style='color:green'>medicines table exists.</p>";
        }
    }
    ...
    $addForeignKeysSql = "
        ...
        ADD CONSTRAINT `prescription_medicines_ibfk_1` 
        FOREIGN KEY (`prescription_id`) REFERENCES `prescriptions` (`id`) ON DELETE CASCADE,
        ADD CONSTRAINT `prescription_medicines_ibfk_2` 
        FOREIGN KEY (`medicine_id`) REFERENCES `medicines` (`id`) ON DELETE CASCADE;
    ";
    
    try {
        $addForeignKeysStmt = $pdo->prepare($addForeignKeysSql);
        $addForeignKeysStmt->execute();
        echo "<p style='color:green'>Successfully added foreign key constraints to prescription_medicines table!</p>";
    } catch (PDOException $e) {
        echo "<p style='color:orange'>Note: " . $e->getMessage() . "</p>";
        echo "<p>This may be expected if the constraints already exist or if table names differ.</p>";
    }
    
    echo "<p>Database setup complete! <a href='pharmacist/dashboard.php'>Go to Pharmacy Dashboard</a></p>";
